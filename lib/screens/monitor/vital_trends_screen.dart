...
class _VitalTrendsScreenState extends State<VitalTrendsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final meta = VitalMeta.all[_selected]!;
  ...
  Widget _buildChart(List<VitalSnapshot> data, VitalMeta meta) {
    final threshold = _defaultThresholds[_selected];
    final spots = <FlSpot>[];
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Container(width: 1, height: 32, color: AppColors.textSecondary.withOpacity(0.15)),
